...
**Date:** 2026-04-24
**Status:** Complete — ~5 hours of play; the tomb combat was resolved and the party rested on the tomb level
**Note:** Exact session number unknown, estimated ~10–11
**Source:** Transcript `2026-04-24 18-40-14-transcript.txt` (raw transcript not committed). Later sections below were reconstructed in a second pass — the original summary stopped around the faction-button exploration.
...
**Initiative order:** Burt (Stephen), OJ (Eric), Bruce (Andrew), Rowan (Brian), Fraxiga (Justin) — Burt went last with roll of 3
...
- Final bird: Burt (Stephen) killed it while Rowan (Brian) choked it
- **XP:** 13 base × 8 = **104 XP total** (DM did the math on-mic; an earlier "832" was an error)
...
- Burt (Stephen) ran in (has cat of nine lives pendant / poison resistance), scooped treasure
...
Party camped in the first priest quarters (hobgoblin room). **Black Lotus side effect:** Burt (Stephen) hallucinated being a wolf chasing glowing fireflies. Wore off by morning.
...
**Initiative:** Fraxiga (Justin), Dougal (Nicky), then others.

**Combat:**
- First gecko attacked from front; second dropped from ceiling and targeted Burt (Stephen)
- Burt (Stephen): 16 to hit, 5 damage (vampire dagger)
...
- Corridor goes 60 ft, turns south, dead-ends into a door leading to the Ariadne faction area.
- **Ariadne ceremonial chamber:** altar in the NE corner with green-and-white cloth, a 3-ft stone statue of a woman weaving and holding scissors (the Fates), two white candles, three incense braziers, white wall drapes, green carpet — clean and tended. Secret door in the SE corner.
- **Ariadne treasury/vault** (behind the secret door): stone vault with a keyhole; **Burt picked it. Loot: 1,000 gp, a 600 gp gem, 300 gp in jewelry.** A second secret door led onward.
- **Pandora** (Ariadne faction leader) and two women guards (bronze chainmail over green tunics, bronze Ariadne-face masks) were seated at a table beyond, surprised the party emerged from their treasury's secret door. Pandora told them they were trespassing in sacred areas and sent them out; she pushed the hallway button to eject them. See npcs/pandora.md.
...
### The "King Alexander" Escort (Yellow-Robe Worshippers)

Six humans in **bright yellow robes and human-face masks** mistook **Dougal for the resurrected King Alexander** (and the party for royalty) — they bowed and scraped. Their herald, **Polycrates**, apologized for not recognizing "his king" and offered service. Dougal **leaned into the impersonation**, using the Staff of Healing as a "kingly touch" to bless them. They then escorted the party **north toward the city archives**, zigzagging to avoid snakes on the floor. See npcs/polycrates.md.

### King Alexander Tomb Room

30×30 room; walls painted with court scenes of **King Alexander and Queen Zenobia** entertained by a **dwarven jester**. A small pharaoh-style coffin/sarcophagus sat in an east-wall niche; four large brass jars/urns stood in the corners (empty, fixed to the floor). The coffin was a **jack-in-the-box trap** — the lid sprang open on a coil with a wooden jester head (jump-scare, no damage). Doors north and center.
...
**Skeleton and Mummy Combat (resolved this session):**

Beyond the arch: **25 skeletons (16 HP each, AC 14 / chainmail)** and a **mummy**.

- Bruce (Andrew): 13 damage to skeletons (Lightning Bolt)
- **Mummy fear aura:** save vs. paralysis or be paralyzed with fear. Rowan (Brian) failed (rolled 10) — legs locked. The mummy's touch (negates armor, dex only) hit Dougal (Nicky) for **10 damage** (and inflicted **mummy rot**).
- **Horn of Valhalla** (party item, jokingly "horn of Gondor"): blown by the horn's bearer — roll for what is summoned + how many → **7 second-level fighter "berserkers."** They brawled the skeletons and cut down ~10 of them, then vanished ("back to Valhalla") when the fight ended.
- The party finished the rest; **Bruce landed the 17-damage kill shot on the mummy.**
- **XP: 250 (skeletons) + 400 (mummy).**

**Rest (tomb level):** Party rested and re-prepared spells. **Dougal used a scroll of Cure Disease on himself** to treat the mummy rot (a mummy-rot victim must cure it themselves — the Staff of Healing can't be self-used).

**Session ended here (~midnight, ~5 hours of play).** DM note: the second floor is "political stuff" plus this burial-tomb level; next session starts fresh.
...
*(Button-number labels above are inferred; the transcript doesn't consistently number them.)*

---

### Items & Rulings

- **Horn of Valhalla** (party item; called "horn of Gondor" in jest) — blown in the tomb combat. Roll once for what is summoned, once for quantity; produced **7 second-level fighter berserkers** that fight and then vanish when combat ends. See items/horn-of-valhalla.md.
- **Rowan's flaming sword is +3 vs. undead** (stated in the tomb combat).
- **Mummy rot:** the touch inflicts a disease only the afflicted can cure; a cleric **cannot** use the Staff of Healing on himself for it (Dougal used a Cure Disease scroll instead).
- **Turning undead:** at cleric level 6, turning a mummy needs **7+ on 2d6** (established, though not attempted this fight).

---

### Open Threads (from this session)

- **Dougal is believed to be King Alexander** by the yellow-robe worshippers (Polycrates & co.), who escorted the party toward the archives — social leverage in Apocryphon-adjacent territory.
- **Pandora / the Ariadne faction** left on wary terms — an unexplored relationship.
