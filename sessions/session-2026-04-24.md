...
**Initiative order:** Steven, Eric, Andrew, Brian, Justin, Snook (Steven went last with roll of 3)

**Combat summary:**
- Eric (round 1): 18+7 to hit, 6+5=11 damage — split first beetle in half on arrival
- Andrew: Magic missile (spell) — wounded a bird attacking the wizard
- Brian: Natural 20 — doubled damage, 12 points — killed second beetle
- Cleave attempt on third: rolled 2, missed
- Combat continued — party killed all 8 birds over several rounds
- Rowan took 2 HP damage (Nat 20 bird attack) and 3 HP drain from a bird latching on with its beak
- Brian grappled a bird bare-handed, 3 points damage, nearly killed it
- Dog (DAFCO +3): 13 hit, 10 damage — killed one
- Final bird: Steven killed it while Rowan choked it
- **XP:** 104 XP per creature × 8 = 832 XP total (13 XP base × 8)
...
- Rowan ran in (has ring of cat with nine lives / poison resistance), scooped treasure
...
Party camped in the first priest quarters (hobgoblin room). **Black Lotus side effect:** one party member (druid/Snook) experienced cat-like effects from lotus exposure; wore off by morning.
...
**Wizard (Andrew returned):** Lightning Bolt, Hold Person, Web ×2, Magic Missile ×2 (3 bolts each at level 6).
...
**Initiative:** Justin, Snook, Nicky, then others.

**Combat:**
- First gecko attacked from front; second targeted Burt (dropped from ceiling)
- Burt: 16 to hit, 5 damage (vampire dagger)
- Cleric: 21 to hit, 8 damage — killed first gecko
- Fumble: flaming sword skidded under the bed (still lit)
- Cleric: 21 to hit, 8 damage — killed second gecko
- **XP: 100 total**

**After combat:** Rowan reached under bed, retrieved flaming sword. Behind the bed: body of a **dead Syncydian**, partially eaten by the gecko. Wore a **bird-face mask inlaid with gold**. Party took the mask.

OJ wanted to wear it on the back of his head to deter tiger attacks (sprites mentioned tigers in the city). DM allowed it, called it weird.
...
**Party approach:** OJ tried to bluff ("we forgot our masks"). Canadius recognized them as outsiders immediately.
...
- Andrew: 13 damage to skeletons with magic (Lightning Bolt or similar)
- Skeletons were engaged across multiple rounds
- **Mummy** created a paralysis/fear effect on approach:
  - Brian failed save vs. paralysis (rolled 10, needed over 12; cloak +1 to saves not sufficient)
  - Brian's legs locked up — paralyzed with fear
  - Mummy: touch attack (negates armor, only dex modifier applies), hit Dougal for **10 damage**
