...
- Each tube has a lower door leading to another room (description pending)
...
Each tube also has a lower door leading to a separate room (rooms not yet described — pending).
